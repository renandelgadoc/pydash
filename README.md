...
Implementation of [FDash](https://ieeexplore.ieee.org/document/7368091) in python [r2a_fdash.py](r2a/r2a_fdash.py), tested and simulated on [pyDash](https://github.com/mfcaetano/pydash).
